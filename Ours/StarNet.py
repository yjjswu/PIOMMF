...
class StarNet(nn.Module):
    def __init__(self, base_dim=32, depths=[3, 3, 12, 5], mlp_ratio=4, drop_path_rate=0.0, num_classes=1000, **kwargs):
        ...
        self.in_channel = 32
        # stem layer
        self.stem = nn.Sequential(ConvBN(48, self.in_channel, kernel_size=3, stride=1, padding=1), nn.ReLU6())
        ...
        self.head2=nn.Linear(self.in_channel,num_classes)
        # self.HyperG = HGNN(28 * 28, 1, 4, 0.4)
        ...
        self.fusion_model = MultiViewFusion(in_channels=1, out_channels=48, H=448, W=448)
    ...
    def Get_HyperGraph_2(self, img):
        ...
        for i in range(img.size(0)):
            ...
            # 构造超图并生成图矩阵
            H1 = hgut_gpu.construct_H_with_KNN(ft_cewei_wowei, K_neigs=[3],
            ...
            H2 = hgut_gpu.construct_H_with_KNN(ft_cewei_liwei, K_neigs=[3],
                                                split_diff_scale=False,
                                                is_probH=True, m_prob=1).cuda()
            ...
            H3 = hgut_gpu.construct_H_with_KNN(ft_wowei_liwei, K_neigs=[3],
                                                split_diff_scale=False,
                                                is_probH=True, m_prob=1).cuda()
