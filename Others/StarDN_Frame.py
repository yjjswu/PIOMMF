...
class StarNet(nn.Module):
    def __init__(self, base_dim=32, depths=[3, 3, 12, 5], mlp_ratio=4, drop_path_rate=0.0, num_classes=1000, **kwargs):
        ...
        # self.backbone=timm.models.mambaout.mambaout_tiny(in_chans=64,num_classes=128)
        self.backbone=timm.models.shivit.shvit_s1(in_chans=64,num_classes=128)
        # head
    ...
    def forward(self, x,x_f):
        ...
        # print(x_f2.shape)
        # x_f2 = x+0.5*self.selfattn2(x_f2)+0.5*x_f2
        x = self.head2(x)
        return x
        # return x
...
def Test_Model():
    model = starnet_s050(num_classes=4).cuda()
