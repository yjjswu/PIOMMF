...
Dataset1 = DataLoader(Dataset(r"D:\ZJF\pythongrams\coding\Datas",True), batch_size=12, shuffle=True)
Dataset2 = DataLoader(Dataset(r"D:\ZJF\pythongrams\coding\Datas",False), batch_size=12, shuffle=True)
